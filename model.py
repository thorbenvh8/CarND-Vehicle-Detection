...
def load_data(orient, pix_per_cell, cell_per_block, test_size=0.2):
    ...
    X_train = features.get_features_list("Load features X_train", X_train, orient=ORIENT, pix_per_cell=PIX_PER_CELL, cell_per_block=CELL_PER_BLOCK)
    ...
    X_test = features.get_features_list("Load features X_test", X_test, orient=ORIENT, pix_per_cell=PIX_PER_CELL, cell_per_block=CELL_PER_BLOCK)
